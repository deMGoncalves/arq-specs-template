...
function GenericScenarioSection({
  section,
  relatedAdrs,
  relatedFeatures,
  relatedContainers,
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex flex-col gap-2">
          <Button variant="ghost" size="sm">
            <Link to="/scenarios/overview" className="flex items-center gap-2">
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              ADRs conectadas a este capítulo.
            </CardDescription>
          </CardHeader>
              ...
              relatedAdrs.map((adr) => (
                ...
                >
                  ...
                  <div className="mt-3 flex justify-end">
                    <Button variant="ghost" size="sm">
                      <Link
                        to={`/scenarios/SCN-009/adrs/${adr.id}`}
              ...
              relatedFeatures.map((feature) => (
                ...
                >
                  ...
                  <div className="mt-3 flex justify-end">
                    <Button variant="ghost" size="sm">
                      <Link
                        to={`/scenarios/SCN-006/bdd/${feature.id}`}
                        className="flex w-full items-center justify-center"
                      >
                        Abrir feature
                      </Link>
...
export default GenericScenarioSection;
